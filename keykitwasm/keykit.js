...
// Begin JS library code
  ...
  function _js_draw_line(x0, y0, x1, y1) {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) return;
          var ctx = canvas.getContext('2d');
          ctx.beginPath();
  ...
  function _js_draw_rect(x, y, w, h) {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) return;
          var ctx = canvas.getContext('2d');
  ...
  function _js_draw_text(x, y, text) {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) return;
          var ctx = canvas.getContext('2d');
  ...
  function _js_fill_ellipse(x, y, radiusX, radiusY) {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) return;
          var ctx = canvas.getContext('2d');
          ctx.beginPath();
  ...
  function _js_fill_polygon(xPoints, yPoints, numPoints) {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) return;
          var ctx = canvas.getContext('2d');
  ...
  function _js_fill_rect(x, y, w, h) {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) return;
          var ctx = canvas.getContext('2d');
  ...
  function _js_get_canvas_height() {
          var canvas = document.getElementById('keykit-canvas');
          return canvas ? canvas.height : 0;
      }

  function _js_get_canvas_width() {
          var canvas = document.getElementById('keykit-canvas');
  ...
  function _js_get_midi_input_name(index, buffer, buffer_size) {
          if (!window.midiInputs || index < 0 || index >= window.midiInputs.length) {
  ...
  function _js_get_midi_output_count() {
  ...
  function _js_get_midi_output_name(index, buffer, buffer_size) {
  ...
  function _js_setup_mouse_events() {
          var canvas = document.getElementById('keykit-canvas');
          if (!canvas) {
              console.error('KeyKit canvas element not found!');
              return;
...
var wasmImports = {
  ...
  /** @export */
  js_draw_rect: _js_draw_rect,
  /** @export */
  js_draw_text: _js_draw_text,
  /** @export */
  js_fill_ellipse: _js_fill_ellipse,
  /** @export */
  js_fill_polygon: _js_fill_polygon,
  /** @export */
  js_fill_rect: _js_fill_rect,
  /** @export */
